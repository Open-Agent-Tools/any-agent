...
class TestMVPPipeline:
    ...
    def test_adk_adapter_detects_test_agent(self):
        ...
        test_agent_path = Path(__file__).parent.parent.parent / "examples" / "adk" / "agent_only"
    ...
    def test_full_pipeline_dry_run(self, mock_post, mock_get, mock_subprocess):
        ...
        health_response.json.return_value = {"status": "healthy", "agent_name": "test", "framework": "google_adk"}
        
        # Mock describe endpoint
        describe_response = MagicMock()
        describe_response.status_code = 200
        describe_response.json.return_value = {"name": "test_agent", "framework": "google_adk"}
    ...
    def test_port_conflict_stops_pipeline(self):
        ...
        with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as sock:
            ...
            assert f"Port {busy_port} is not available" in results["steps"]["port_check"]["error"]
            ...
            if "suggested_port" in results["steps"]["port_check"]:
                ...
                if suggested:
                    ...
                    try:
                        ...
                        pytest.fail(f"Suggested port {suggested} is not actually available")