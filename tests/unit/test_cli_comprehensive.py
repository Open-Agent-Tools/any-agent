...
class TestCLIComprehensiveCoverage:
    ...
    def test_cli_custom_container_name(self):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(main, [
                "test_agent",
                "--container-name", "my-custom-agent",
                "--dry-run"
            ])
    ...
    @pytest.mark.skip(reason="--push option removed during QA cleanup - unimplemented feature")
    def test_cli_push_option(self):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(main, [
                "test_agent",
                "--push", "registry.example.com/my-agent:latest",
                "--dry-run"
            ])
    ...
    @pytest.mark.skip(reason="--protocol option removed during QA cleanup - unimplemented feature")
    ...
    @pytest.mark.skip(reason="--helmsman-token option removed during QA cleanup - unimplemented feature")
    def test_cli_helmsman_token_option(self):
        ...
        with runner.isolated_filesystem():
            ...
            result = runner.invoke(main, [
                "test_agent",
                "--helmsman",
                "--helmsman-token", "test-token-123",
                "--agent-name", "test-helmsman-agent",
                "--dry-run"
            ])
    ...
    @patch('any_agent.core.orchestrator.AgentOrchestrator')
    def test_cli_removal_agent_name_detection_fallback(self, mock_orchestrator, mock_context, mock_remover):
    ...
    @patch('any_agent.core.agent_context.AgentContextManager')
    @patch('any_agent.core.orchestrator.AgentOrchestrator')
    def test_cli_removal_no_agent_name_error(self, mock_orchestrator, mock_context, mock_remover):
